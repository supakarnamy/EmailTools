...
def create_html(business_name: str) -> str:
    ...
    <html><body style="font-family:Arial, sans-serif; line-height:1.6;">
      ...
      <div style="text-align:center;margin:16px 0;">
        <img src="{HARDCODED_IMAGE_PATH}" style="max-width:100%; height:auto;" />
      </div>

      <p>ตัวอย่างแบรนด์บน openlink เช่น <a href="https://www.openlink.co/burgerkingthailand">Burger King</a>, <a href="https://www.openlink.co/maguro">Maguro</a>, และอีกหลายพัน หรือสำรวจเพิ่มเติมที่ <a href="https://www.openlink.co/explore">แบรนด์ชั้นนำ</a></p>

      <div style="text-align:center;margin:16px 0;">
        <img src="{HARDCODED_IMAGE_PATH_2}" style="max-width:100%; height:auto;" />
      </div>
