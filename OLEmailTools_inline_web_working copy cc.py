...
# >>> Always-CC list (added)
CC_ALWAYS = ["openlinkco@gmail.com"]
    ...
    <html>
      <body style="font-family:Arial, sans-serif; line-height:1.6; color:#111;">
        ...
        <p>
          ...
          <strong>Invite Package:</strong> openlink ฟรีบริการสร้างและตกแต่งเพจ ใช้งานได้ทันที เพียงตอบกลับอีเมลนี้ภายใน 30 กันยายนนี้
        </p>
    ...
    while attempts < MAX_SEND_RETRIES:
        ...
        try:
            ...
            try:
                ...
                # send_message() will include To, Cc (and Bcc if set) automatically
